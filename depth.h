...
#define GL_IMPLEMENTATION_COLOR_READ_FORMAT 0x8B9B
    ...
    public:
        ...
        static bool Capture (osg::ref_ptr<osg::Node> _node, const double _pixel_size, double _refLatitude, double _refLongitude, const std::string& _fileName, osg::Vec3d _eye, osg::Vec3d _target, osg::Vec3d _up);
